...
import com.music.frame.imageviewpager.tool.MyToast;
...
public class ImageviewpagerActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_imageview_pager);
        ...
        findViewById(R.id.buttonThumb).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ImagePreview
                        .getInstance()
                        .setContext(ImageviewpagerActivity.this)// 上下文
        ...
        findViewById(R.id.buttonOrigin).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ImagePreview
                        .getInstance()
                        .setContext(ImageviewpagerActivity.this)
                        .setIndex(0)
        ...
        findViewById(R.id.buttonClean).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ImageLoader.cleanDiskCache(ImageviewpagerActivity.this);
                MyToast.getInstance()._short(ImageviewpagerActivity.this, "磁盘缓存已成功清除");
            }
        });
    }
